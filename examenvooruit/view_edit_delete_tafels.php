...
if (isset($_GET['id'])) {
    ...
    header("location: view_edit_delete_tafels.php");
    exit;
}
  ...
  if(isset($_POST['export'])){
      ...
      $result = $db->get_tafels_information(NULL);
      if(!empty($result)){
...
<html>
  <head>
    <meta charset="utf-8">
    <title>View edit and delete tafels</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>View edit and delete tafels</b></h2>
                            <a class="btn btn-success" href="tafels_toevoegen.php" class="edit_btn" >create tafels</a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <?php foreach($results as $rows => $row){ ?>
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td>
                                <a class="btn btn-info" href="tafels_wijzigen.php?id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="edit_btn" >Edit</a>
                            </td>
                            <td>
                              <a class="btn btn-danger" href="view_edit_delete_tafels.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="del_btn">Delete</a>
                          </td>
                      </tr>

                    <?php } ?>
              </table>
              <form action='view_edit_delete_tafels.php' method='POST'>
