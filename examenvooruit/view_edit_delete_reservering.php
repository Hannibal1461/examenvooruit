...
if (isset($_GET['id'])) {
  ...
  if(isset($_POST['export'])){
      ...
      $result = $db->get_reservering_information(NULL);
      if(!empty($result)){
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>View edit and delete reservering</b></h2>
                                <a class="btn btn-success" href="reservering_toevoegen.php" class="edit_btn" >reservering aanmaken</a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach($results as $rows => $row){ ?>
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td>
                                    <a class="btn btn-info" href="reservering_wijzigen.php?id=<?php echo $row_id; ?>" class="edit_btn" >Edit</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="view_edit_delete_reservering.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="del_btn">Delete</a>
                                </td>
                          </tr>
                        <?php } ?>
                  </table>
                  <form action='view_edit_delete_reservering.php' method='POST'>
