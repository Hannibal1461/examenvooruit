...
if (isset($_GET['id'])) {
  ...
  $account=$db->get_menu_information($id);
  // redirect to overview
  header("location: menu_wijzigen.php");
  exit;
}
...
$no_error = $obj->has_provided_input_for_required_fields($fields);
  ...
  if($no_error){
    ...
    $db->update_menu($id, $product, $type, $verkoopprijs);

      header('location: menuwijzigen.php');
      exit;
    }
  }
?>
    ...
    <div class="container" style="margin-top:-250px; margin-right:500px;">
        <div class="table-responsive">
            <div class="table-wrapper">
              ...
              <form method="post" align="center" action='menu_wijzigen.php' method='post' accept-charset='UTF-8'>
                <fieldset>
