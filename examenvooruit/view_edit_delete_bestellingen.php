...
if (isset($_GET['id'])) {
  ...
  if(isset($_POST['export'])){
      ...
      $result = $db->get_bestelling_information(NULL);
      if(!empty($result)){
...
<html>
  <head>
    <meta charset="utf-8">
    <title>View edit and delete bestellingen</title>
  ...
  <body>
    ...
    <?php
        ...
        $results = $db->get_bestellingen_information(NULL);
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>View edit and delete bestellingen</b></h2>
                                <a class="btn btn-success" href="bestellingen_toevoegen.php" class="edit_btn" >bestellingen aanmaken</a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach($results as $rows => $row){ ?>
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td>
                                    <a class="btn btn-info" href="bestellingen_wijzigen.php" class="edit_btn" >Edit</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="view_edit_delete_bestellingen.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="del_btn">Delete</a>
                                </td>
                          </tr>
                        <?php } ?>
                  </table>
                  <form action='view_edit_delete_bestellingen.php' method='POST'>
